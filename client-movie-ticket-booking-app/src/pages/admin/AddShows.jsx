    ...
    <>
      ...
      <div className="mt-8">
        ...
        <div className="inline-flex items-center gap-2 border border-gray-600 px-3 py-2 rounded-md">
          <p className="to-gray-400 text-sm">{currency}</p>
          <input
            type="number"
      ...
      <div className="mt-6">
        ...
        <div className="inline-flex  gap-5 border border-gray-600 pl-3 p-1 rounded-lg">
          <input
            type="datetime-local"
            ...
            {Object.entries(dateTimeSelection).map(([date, times]) => (
              <li key={date}>
                ...
                <div className="flex flex-wrap gap-2 mt-1 text-sm">
                  {times.map((time) => (
                    <div key={time} className="border border-primary px-2 py-2 flex items-center rounded">
                      <span className="">{time}</span>
                      <DeleteIcon onClick={() => handleRemoveTime(date, time)} width={15} className="ml-2 text-red-500 hover:text-shadow-red-700 cursor-pointer" />
                    </div>
                  ))}
                </div>
              </li>
